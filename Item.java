...
public class Item{
   ...
   public boolean combine(Item other){ // this = what is on table; other = in hand
      if(other.isPan()){ // holding pan, drop onto tomato
         ...
         String validCombo = " chedou chedoumus chedoumustop chedousau chedoutop doumus doumustop dousau dousautop doutop chedoumussautop doumussautop "; // expand as needed
         for(String n : ingr){
            oList.add(n);
         }
